...
# Example usage:
csv_file = 'products.csv'  # MY CSV file containing product information
json_file = 'products.json'  # JSON file to store the converted data
...
# Write log messages
write_log("This is a log message.", log_file)
write_log("Another log message.", log_file)
