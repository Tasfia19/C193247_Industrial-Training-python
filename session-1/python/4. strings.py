...
Bio_data="name=mim,age=23,country=Bangladesh"
print(Bio_data)
print(Bio_data.split(","))
...
multiple lines within triple quotes."""#""" multi line a use korte hbe
...
text = 'The image is 106px by 209px.'# 6 & 9 asce karon ? disi tai followed by ta asce + dle full asbe
matches = re.findall(pattern, text)
...
text_with_star = "This is a &great day to learn &regex in #Python!"
star = re.findall(r"&(\w+)", text_with_star)
print("star:", star)
