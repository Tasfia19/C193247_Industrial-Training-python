...
def compound_interest(principal, rate, time, comp_per_year):
    # Calculate the number of times interest is compounded
    n = comp_per_year
...
amount = compound_interest(principal, rate, time, comp_per_year)
print("Compound interest after 5 years:", amount)
